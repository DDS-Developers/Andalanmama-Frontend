    ...
    this._panResponder = PanResponder.create({
      onStartShouldSetPanResponderCapture: evt => {
        ...
        this._additionalOffset =
          tappedPixel + this._scrollOffset - this._measurements[tappedRow][horizontal ? 'x' : 'y'];
        ...
        if (this.props.scrollingContainerOffset !== undefined) {
          this._offset.setValue(
            (this._additionalOffset +
              ...
              this.props.scrollingContainerOffset -
              this._androidStatusBarOffset) *
              -1,
          );
        } else {
          this._offset.setValue(
            (this._additionalOffset + this._containerOffset - this._androidStatusBarOffset) * -1,
          );
        }
        return false;
      },
      ...
      onPanResponderRelease: () => {
        ...
        const pos =
          offset - this._scrollOffset + this._additionalOffset + (isLastElement ? size : 0);
