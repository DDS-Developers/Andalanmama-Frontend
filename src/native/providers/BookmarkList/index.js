/**
 * providers/BookmarkList/index.js
 *
 */
...
import {
  ...
  setTotal,
  setPaged,
} from '../../store/BookmarkList/actions';
import {
  makeSelectItems,
  makeSelectSelected,
  ...
  makeSelectTotal,
  makeSelectPaged,
} from '../../store/BookmarkList/selectors';

export const BookmarkListProvider = () => WrappedComponent => {
  ...
  const BookmarkListConnect = connect(
    mapStateToProps,
    mapDispatchToProps,
  )(BookmarkList);

  return hoistNonReactStatics(BookmarkListConnect, WrappedComponent);
};
...
export const withBookmarkList = BookmarkListProvider();
