/**
 * providers/MyRecipeList/index.js
 *
 */
...
import {
  ...
  setTotal,
  setPaged,
} from '../../store/MyRecipeList/actions';
import {
  makeSelectItems,
  makeSelectSelected,
  ...
  makeSelectTotal,
  makeSelectPaged,
} from '../../store/MyRecipeList/selectors';

export const MyRecipeListProvider = () => WrappedComponent => {
...
export const withMyRecipeList = MyRecipeListProvider();
