      ...
      >
        ...
        >
          <Text style={{ fontSize: 14 }}>
            Halaman ini untuk menampilkan resep kamu yang sudah disetujui
          </Text>
        </View>
        <View style={{ marginTop: 12 }}>
          <Button
            onPress={() => {
              changeMyRecipeFilterStatus('unpublished');
              changeMyRecipeFilterLabel('Tidak Dipublikasikan');
              nextStep();
            }}
            style={{
